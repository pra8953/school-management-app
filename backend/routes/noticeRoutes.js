...
const noticeValidation = require('./../validators/noticesValidation');
// ✅ Create Notice
router.post('/',verifyToken,noticeValidation, async (req, res) => {
    try {
...
// ✅ Update Notice
router.put('/:id',verifyToken,noticeValidation, async (req, res) => {
    try {
